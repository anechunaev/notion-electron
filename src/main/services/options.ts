...
class OptionsService {
	#options: BrowserWindow | null = null;
	#config: OptionsConfig;
	#store: AppStore;
	#cliOverrides: Partial<OptionValues> = {};
	#envDefaults: Partial<OptionValues> = {};
	#mainBus: EventEmitter | null = null;

	static #DE_PRESETS: Record<string, Partial<OptionValues>> = {
		gnome: {
			'hide-to-tray': false,
	...
	static #buildEnvDefaults(env: NodeJS.ProcessEnv): Partial<OptionValues> {
	...
	setOptionsWindow(optionsWindow: BrowserWindow): void {
	...
	getOption<K extends keyof OptionValues>(optionId: K): OptionValues[K] {
	...
	getPersistentOption<K extends keyof OptionValues>(optionId: K): OptionValues[K] {
	...
	setPersistentOption(optionId: string, value: unknown): void {
