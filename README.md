...
<a href="https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-x86_64.AppImage">
	<picture>
...
- **Any Distribution `.AppImage`**
	- [x64 / amd64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-x86_64.AppImage)
	- [arm64 / aarch64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-arm64.AppImage)
- **Ubuntu / Debian `.deb` package**
	- [x64 / amd64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-amd64.deb)
	- [arm64 / aarch64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-arm64.deb)
- **Fedora / CentOS / OpenSUSE `.rpm` package**
	- [x64 / amd64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-x86_64.rpm)
	- [arm64 / aarch64](https://github.com/anechunaev/notion-electron/releases/download/v1.9.5/Notion_Electron-1.9.5-aarch64.rpm)
